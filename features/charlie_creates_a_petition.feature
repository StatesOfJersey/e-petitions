...
Scenario: Charlie has to search for a petition before creating one
  ...
  And I should not see "Rioters must loose benefits"
...
Scenario: Charlie tries to submit an invalid petition
  ...
  And I fill in "What do you want us to do?" with "012345678911234567892123456789312345678941234567895123456789012345678911234567892123456789312345678941234567895123456789012345678911234567892123456789Blah"
