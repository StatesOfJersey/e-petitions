...
RSpec.describe Admin::Archived::LocksController, type: :controller, admin: true do
  context "when not logged in" do
    [
      ["GET", "/admin/archived/petitions/:petition_id/lock.json", :show, { petition_id: "100000" }],
      ["POST", "/admin/archived/petitions/:petition_id/lock.json", :create, { petition_id: "100000" }],
      ["PATCH", "/admin/archived/petitions/:petition_id/lock.json", :update, { petition_id: "100000" }],
      ["DELETE", "/admin/archived/petitions/:petition_id/lock.json", :destroy, { petition_id: "100000" }]
